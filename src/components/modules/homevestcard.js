        ...
        return (<Box mx={2}>
            <VStack>
                <TouchableOpacity onPress={() => {
                    if(!hasAccount) {
                        AlertBox.showError("There is no account associated with your profile yet. Please create a new account or link your existing Imperial Homes Mortage bank account if you already have one.", 'No Account')
