...
const ResetPasswordScreen = ({ navigation }) => {
    ...
    const { fetchData: passwordResetRequest } = useAuthentication('password_reset_update', 'post', navigation);
                ...
                <Box >
                    <Center h={'full'} mt={20} w="100%">
                        <Box safeArea px="10" py="8" w="full" >
                            ...
                            {!show_otp && <Box>
                                <VStack space={3} mt="5">
                                    <FormControl required>
                                        ...
                                        {(!email || email.trim().length == 0) && <FormControl.ErrorMessage leftIcon={<WarningOutlineIcon size="xs" />}>
                                    ...
                                    <Button
                                        ...
                                        onPress={() => { initiatePasswordRequest() }}
                            ...
                            {show_otp && <VStack space={3} mt="5">
                                <OTPInput fieldDesc={'OTP'} pinLen={6} onTextComplete={(text) => {
                                    setOTP(text)
                                }} />
                                <FormControl isInvalid>
                                    ...
                                    <Input onChangeText={text => {
                                        ...
                                        value={password} style={Shared.TextInput.default} variant={'rounded'} type={show ? "text" : "password"}
                                ...
                                <FormControl isInvalid>
                                    ...
                                    <Input onChangeText={text => {
                                        ...
                                        value={confirm_password} style={Shared.TextInput.default} variant={'rounded'} type={show ? "text" : "password"}
                                        InputRightElement={<Button size="xs" _text={{ color: '#ffffff' }} variant={'ghost'} rounded="none" w="1/6" h="full" onPress={handleClick}>
                                            {show ? "Hide" : "Show"}
                                        </Button>}
                                    />
                                    {(isFieldInError('confirm_password') || confirm_password != password) && <FormControl.ErrorMessage leftIcon={<WarningOutlineIcon size="xs" />}>
                                ...
                                <Button
                                    ...
                                    isLoading={isLoading}
                                    onPress={() => { completePasswordResetRequest() }}
                                    mt={5} variant={'solid'} w={"full"} style={Shared.Button.primary} >
                                    Reset Password
                                </Button>
