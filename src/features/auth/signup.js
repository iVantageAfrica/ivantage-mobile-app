          ...
          <Center h={"full"} mt={1} w="100%">
            <Box safeArea p="2" py="4" w="full" px={5}>
              ...
              <VStack mt="3">
                ...
                <Box mt={3} style={{ borderColor: "#ffffff", borderWidth: 1 }}>
                  <Text
                    style={{
                      color: "#282828",
                      fontSize: 17,
                ...
                <VStack mt={5} mb={5} space={3}>
                  <Checkbox
                    ...
                    value={agreetoterms}
                  >
                    <Text color={"#282828"}> Agree to</Text>
                    <Link
                      _text={{
                ...
                <Button
                  onPress={() =>
                    navigation.navigate("OTPScreen", { screen: "Profile" })
                  }
                  mt="2"
                  isLoading={isLoading}
                  variant={"solid"}
